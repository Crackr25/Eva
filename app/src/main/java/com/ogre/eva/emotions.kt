...
class Emotions : AppCompatActivity() {
    ...
    private val OPERATION_CAPTURE_PHOTO = 2
    ...
    private fun initializeWidgets() {
        ...
        mImageView = findViewById(R.id.postpic)
    }
    ...
    private fun capturePhoto(){
        ...
        mUri = if(Build.VERSION.SDK_INT >= 24){
            FileProvider.getUriForFile(this, "info.camposha.kimagepicker.fileprovider",capturedImage)
        } else {
